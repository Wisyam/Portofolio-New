    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-brand-text-heading/60">
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-6">
          ...
          <a href="https://www.linkedin.com/in/wisyam-zain-amanullah" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-all duration-300 transform hover:scale-125 hover:drop-shadow-[0_0_8px_rgba(143,155,147,0.5)]"><Icons.LinkedInIcon /></a>
        </div>
      </div>
    </div>
  </footer>
